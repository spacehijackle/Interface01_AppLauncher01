...
public class Startup
{
	public static void main(String[] args)
	{
		 ...
		 */
		Menu menu = new Menu();
		menu.add("ググれカス！", new BrowserLauncher("https://www.google.co.jp/"));
		menu.add("ヤフトピ", new BrowserLauncher("https://news.yahoo.co.jp/"));
		menu.add("メール送信", new MailerLauncher("webmaster@hogehoge.jp"));
		menu.add("IEお気に入り", new IEFavoriteLauncher());
		menu.add("終了する", new Terminator());
